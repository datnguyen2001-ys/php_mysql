    ...
    if(isset($_SESSION['user_name']) && $_SESSION['user_name'] != null){
        ...
        <?php
            ...
            if (isset($_POST['submit_slider'])) {
                  $add_slider = $slider->add($_POST,$_FILES);
            }
        ?>
<html lang="en">
...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <form method="POST" action="add_slider.php" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="slider_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                ...
                <div class="form-group col-sm-6">
                    ...
                    <select style="width: 100%" name="slider_status"  id="exampleFormControlSelect2">
                ...
                <button style="margin-top: 20px" name="submit_slider" type="submit" class="btn btn-primary">Submit</button>
            </form>
            <!-- Widgets End -->
                    </div>
                </div>
