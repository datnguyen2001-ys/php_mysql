        ...
        <?php
            ...
            if (isset($_POST['submit_product']) && isset($_FILES['product_image'] )) {
                if ($_FILES['product_image']['error'] > 0){
                    ...
                    $product_add = $product->add($_POST,$_FILES);
                }
...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <form method="POST" action="add_product.php" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input multiple="multipart" type="file"  name="product_images[]" id="">
                </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <select style="width: 100%" name="product_status"  id="exampleFormControlSelect2">
