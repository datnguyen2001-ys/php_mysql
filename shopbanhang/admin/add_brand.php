...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <form method="POST" action="add_brand.php">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <select style="width: 100%" name="brand_status"  id="exampleFormControlSelect2">
                ...
                <button style="margin-top: 20px" name="submit_brand" type="submit" class="btn btn-primary">Submit</button>
            </form>
            <!-- Widgets End -->
                    </div>
                </div>
