            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    ...
                    $product = new product();
                        ...
                        $add_cate = $product->show_product();
                        foreach ($add_cate as $key => $value) {
                            
                    $brand_id = new brand();
                    $select1 = $brand_id->show_brand_byID($value['brand_id']);

                    $category_id = new category();
                    $select2 = $category_id->show_category_byID($value['category_id']);
                            ?>
                            <tr>
                            
                            <td><?php echo $value['product_name']  ?></td>
                            <td><?php echo $value['product_desc']  ?></td>
                            <td><img style="width: 50px;height: 50px;" src="./uploads/<?php echo $value['product_image']  ?>"></td>
                           
                            <td> 
                            <?php
                            foreach($select2 as $key => $vla){
                                echo $vla['category_name'] ;
                             ...
                             <td> 
                            <?php
                            foreach($select1 as $key => $vla1){
                                echo $vla1['brand_name'] ;
                            ...
                            <td>
                                ...
                                if($value['product_status'] == 0  ){
                                    ?>
                                    <a href="active_product.php?active=<?php echo  $value['product_id'] ?>"><i class="fa-solid fa-toggle-off"></i></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="unactive_product.php?active=<?php echo  $value['product_id'] ?>"><i class="fa-solid fa-toggle-on"></i></a>
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                <a href="edit_product.php?edit=<?php echo  $value['product_id'] ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                                <a onclick="return confirm('bạn có muốn xóa?')" href="delete_product.php?delete=<?php echo  $value['product_id'] ?>"><i class="fa-solid fa-xmark"></i></a>
                            </td>
                            </tr>
