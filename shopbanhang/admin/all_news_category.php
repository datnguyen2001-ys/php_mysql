            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    ...
                    $news_category = new news_category();
                        ...
                        $news_category_show = $news_category->show_news_category();
                        foreach ($news_category_show as $key => $value) {
                            ?>
                            <tr>
                            <th scope="row"><?php echo $value['news_category_id']  ?></th>
                            <td><?php echo $value['news_category_name']  ?></td>
                            <td><?php echo $value['news_category_desc']  ?></td>
                            <td>
                                <?php 
                                if($value['news_category_status'] == 0  ){
                                    ?>
                                    <a href="active_news_category.php?active=<?php echo  $value['news_category_id'] ?>"><i class="fa-solid fa-toggle-off"></i></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="unactive_news_category.php?active=<?php echo  $value['news_category_id'] ?>"><i class="fa-solid fa-toggle-on"></i></a>
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                <a href="edit_news_category.php?edit=<?php echo  $value['news_category_id'] ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                                <a onclick="return confirm('bạn có muốn xóa?')" href="delete_news_category.php?delete=<?php echo  $value['news_category_id'] ?>"><i class="fa-solid fa-xmark"></i></a>
                            </td>
                            </tr>
