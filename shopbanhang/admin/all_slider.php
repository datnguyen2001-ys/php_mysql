                ...
                <div class="bg-light rounded-top p-4">
                    ...
                    $slider = new slider();
                        ...
                        foreach ($add_cate as $key => $value) {
                            ...
                            <td><?php echo $value['slider_desc']  ?></td>
                            <td><img style="width: 50px;height: 50px;" src="./uploads/<?php echo $value['slider_image']  ?>"></td>
   
                            <td>
                                <?php 
                                if($value['slider_status'] == 0  ){
                                    ?>
                                    <a href="active_slider.php?active=<?php echo  $value['slider_id'] ?>"><i class="fa-solid fa-toggle-off"></i></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="unactive_slider.php?active=<?php echo  $value['slider_id'] ?>"><i class="fa-solid fa-toggle-on"></i></a>
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                <a href="edit_slider.php?edit=<?php echo  $value['slider_id'] ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                                <a onclick="return confirm('bạn có muốn xóa?')" href="delete_slider.php?delete=<?php echo  $value['slider_id'] ?>"><i class="fa-solid fa-xmark"></i></a>
                            </td>
                            </tr>
