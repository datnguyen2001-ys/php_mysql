...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    ...
                    $lan1 = new news_category();
                    $news = new news();
                    
                        $news_show = $news->show_news();
                        foreach ($news_show as $key => $value) {
                            $row = $lan1->show_news_category_byID($value['news_category_id']);
                            ?>
                            <tr>
                            <th scope="row"><?php echo $value['news_id']  ?></th>
                            <td><?php echo $value['news_title']  ?></td>
                            <td><?php echo $value['news_desc']  ?></td>
                             
                            <td>
                                <?php
                                    $name1;
                                    foreach($row as $key => $value1){
                                        $name1 = $value1['news_category_name'];
                                    }
                                    echo $name1;
                                ?>
                          </td>
                            ...
                            <td>
                                ...
                                if($value['news_status'] == 0  ){
                                    ?>
                                    <a href="active_news.php?active=<?php echo  $value['news_id'] ?>"><i class="fa-solid fa-toggle-off"></i></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="unactive_news.php?active=<?php echo  $value['news_id'] ?>"><i class="fa-solid fa-toggle-on"></i></a>
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                <a href="edit_news.php?edit=<?php echo  $value['news_id'] ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                                <a onclick="return confirm('bạn có muốn xóa?')" href="delete_news.php?delete=<?php echo  $value['news_id'] ?>"><i class="fa-solid fa-xmark"></i></a>
                            </td>
                            </tr>
