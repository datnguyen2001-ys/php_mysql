...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                if (isset($_GET['edit'])) {
                    ...
                    $category = new category();
                       if (isset($_POST['submit_update'])) {
                        $update_cate = $category->update_category($id,$_POST);
                    }
                    $add_cate = $category->show_category_byID($id);
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" value="<?php echo  $value['category_name'] ?>" name="category_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                   
                </div>
                <div class="form-group col-sm-6">
                    <label for="exampleInputPassword1">mô tả</label>
                    <textarea  name="category_desc" rows="8" class="form-control" id="exampleInputPassword1">
