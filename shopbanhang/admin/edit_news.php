...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                if (isset($_GET['edit'])) {
                    ...
                    $news = new news();
                       if (isset($_POST['submit_update'])) {
                        $update_cate = $news->update_news($id,$_POST);
                    }
                    $add_cate = $news->show_news_byID($id);
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" value="<?php echo  $value['news_title'] ?>" name="news_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                   
                </div>
                <div class="form-group col-sm-12">
                    <label for="exampleInputPassword1">mô tả</label>
                    <textarea  name="news_desc" rows="8" class="form-control" id="exampleInputPassword1">
                    <?php echo  $value['news_desc'] ?>
                    </textarea>
