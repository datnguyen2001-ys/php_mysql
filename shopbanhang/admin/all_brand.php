            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    ...
                    $brand = new brand();
                        ...
                        $brand_show = $brand->show_brand();
                        foreach ($brand_show as $key => $value) {
                            ?>
                            <tr>
                            <th scope="row"><?php echo $value['brand_id']  ?></th>
                            ...
                            <td>
                                ...
                                if($value['brand_status'] == 0  ){
                                    ?>
                                    <a href="active_brand.php?active=<?php echo  $value['brand_id'] ?>"><i class="fa-solid fa-toggle-off"></i></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="unactive_brand.php?active=<?php echo  $value['brand_id'] ?>"><i class="fa-solid fa-toggle-on"></i></a>
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                <a href="edit_brand.php?edit=<?php echo  $value['brand_id'] ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                                <a onclick="return confirm('bạn có muốn xóa?')" href="delete_brand.php?delete=<?php echo  $value['brand_id'] ?>"><i class="fa-solid fa-xmark"></i></a>
                            </td>
                            </tr>
