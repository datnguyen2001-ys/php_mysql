    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.php" class="navbar-news_category mx-4 mb-3">
...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="index.php" class="navbar-news_category d-flex d-lg-none me-4">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                if (isset($_GET['edit'])) {
                    ...
                    $news_category = new news_category();
                       if (isset($_POST['submit_update'])) {
                        $update_cate = $news_category->update_news_category($id,$_POST);
                    }
                    $add_cate = $news_category->show_news_category_byID($id);
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" value="<?php echo  $value['news_category_name'] ?>" name="news_category_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                   
                </div>
                <div class="form-group col-sm-6">
                    <label for="exampleInputPassword1">mô tả</label>
                    <textarea  name="news_category_desc" rows="8" class="form-control" id="exampleInputPassword1">
                    <?php echo  $value['news_category_desc'] ?>
                    </textarea>
