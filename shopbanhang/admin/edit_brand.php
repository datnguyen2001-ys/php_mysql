...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                if (isset($_GET['edit'])) {
                    ...
                    $brand = new brand();
                       if (isset($_POST['submit_update'])) {
                        $update_cate = $brand->update_brand($id,$_POST);
                    }
                    $add_cate = $brand->show_brand_byID($id);
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" value="<?php echo  $value['brand_name'] ?>" name="brand_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                   
                </div>
                <div class="form-group col-sm-6">
                    <label for="exampleInputPassword1">mô tả</label>
                    <textarea  name="brand_desc" rows="8" class="form-control" id="exampleInputPassword1">
                    <?php echo  $value['brand_desc'] ?>
                    </textarea>
