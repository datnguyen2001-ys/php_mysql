...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                if (isset($_GET['edit'])) {
                    ...
                    $slider = new slider();
                       if (isset($_POST['submit_update'])) {
                        $update_cate = $slider->update_slider($id,$_POST);
                    }
                    $add_cate = $slider->show_slider_byID($id);
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" value="<?php echo  $value['slider_name'] ?>" name="slider_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  >
                   
                </div>
                <div class="form-group col-sm-6">
                    <label for="exampleInputPassword1">mô tả</label>
                    <textarea  name="slider_desc" rows="8" class="form-control" id="exampleInputPassword1">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <img style="width: 100px" src="./uploads/<?php echo $value['slider_image']  ?>" alt=""  ><br>
                    <input style="margin-top: 10px" type="file"  name="slider_image" id="">
            </div>
                
               
            <button style="margin-top: 20px" name="submit_update" type="submit" class="btn btn-primary">Submit</button>
            </form>
            <?php
            }
            ?>
